    ...
    'columns' => [
        ...
        'type' => [
	        ...
	        'config' => [
			    ...
			    'renderType' => 'selectSingle',
			    'items' => [
			        ['LLL:EXT:teasermenu/Resources/Private/Language/locallang_db.xlf:tx_teasermenu_domain_model_teaseritem.type.default', 0],
			        ['LLL:EXT:teasermenu/Resources/Private/Language/locallang_db.xlf:tx_teasermenu_domain_model_teaseritem.type.spacer', 1],
			    ],
			    'size' => 1,
			    'maxitems' => 1,
			    'eval' => 'required'
	    ...
	    'layout' => [
	        ...
	        'config' => [
			    ...
			    'renderType' => 'selectSingle',
			    'items' => [
			        ['LLL:EXT:teasermenu/Resources/Private/Language/locallang_db.xlf:tx_teasermenu_domain_model_teaseritem.layout.select', 0],
			    ],
			    'size' => 1,
			    'maxitems' => 1,
			    'eval' => ''
